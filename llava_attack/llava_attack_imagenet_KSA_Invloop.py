...
for ATTACK_SAMPLE in $(seq 1 5); do
    for CHOSEN_LAN_LAYER in $(seq 0 5); do
        for CHOSEN_VIS_LAYER in $(seq 0 23); do
            python llava_attack/llava_attack_imagenet_KSA_loop.py --attck_type saa_loop --desired_norm_l_inf 0.04 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers $CHOSEN_LAN_LAYER --chosenVisLayers $CHOSEN_VIS_LAYER 
            python llava_attack/llava_attack_imagenet_KSA_loop.py --attck_type saa_loop --desired_norm_l_inf 0.04 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers $CHOSEN_LAN_LAYER --chosenVisLayers $CHOSEN_VIS_LAYER 
        done
    done
done
...
cd interpretAttacks/
conda activate llava15
python llava_attack/llava_attack_imagenet_KSA_Invloop.py --attck_type saa_Invloop --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample 1 --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP gate_proj --whichMLPVis fc2 --chosenLanLayers 0 --chosenVisLayers 0


export CUDA_VISIBLE_DEVICES=2
cd interpretAttacks/
conda activate llava15
python llava_attack/llava_attack_imagenet_KSA_Invloop.py --attck_type saa_Invloop --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample 1 --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.9 --whichMLP gate_proj --whichMLPVis fc2 --chosenLanLayers 0 --chosenVisLayers 0
