...
for ATTACK_SAMPLE in $(seq 1 100); do
    python llava_attack/llavaAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.006 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 100); do
    python llava_attack/llavaAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.007 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 100); do
    python llava_attack/llavaAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.008 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 100); do
    python llava_attack/llavaAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.009 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
