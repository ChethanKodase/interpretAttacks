...
conda activate llava15
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llava_attack_imagenet_KSA_loopNoComb.py --attck_type saa_loopNC --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --BalAlpha 0 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers 1 3 --chosenVisLayers 7 8 17 13
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llava_attack_imagenet_KSA_loopNoComb.py --attck_type saa_loopNC --desired_norm_l_inf 0.0025 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --BalAlpha 0 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers 1 3 --chosenVisLayers 7 8 17 13
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llava_attack_imagenet_KSA_loopNoComb.py --attck_type saa_loopNC --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --BalAlpha 0 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers 1 3 --chosenVisLayers 7 8 17 13
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llava_attack_imagenet_KSA_loopNoComb.py --attck_type saa_loopNC --desired_norm_l_inf 0.0035 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --BalAlpha 0 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers 1 3 --chosenVisLayers 7 8 17 13
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llava_attack_imagenet_KSA_loopNoComb.py --attck_type saa_loopNC --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --BalAlpha 0 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers 1 3 --chosenVisLayers 7 8 17 13
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llava_attack_imagenet_KSA_loopNoComb.py --attck_type saa_loopNC --desired_norm_l_inf 0.0045 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --BalAlpha 0 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers 1 3 --chosenVisLayers 7 8 17 13
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llava_attack_imagenet_KSA_loopNoComb.py --attck_type saa_loopNC --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --BalAlpha 0 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers 1 3 --chosenVisLayers 7 8 17 13
done
