...
def get_adv_output_path(attck_type, attackSample, epsilon):
    ...
    if attck_type == "saa_loopC_p1":
        attck_typeR = "saa_loopC"
        whichMLP = "gate_proj"
        whichMLPVis = "fc1"
        BalAlpha = 0.01
        return (
    ...
    if attck_type == "saa_loopNC":
        attck_typeR = "saa_loopNC"
        whichMLP = "gate_proj"
        whichMLPVis = "fc1"
        BalAlpha = 0.0
        return (
    ...
    #advOutput_attackType_saa_loopNC_lr_0.001_eps_0.002_AttackStartLayer_0_numLayerstAtAtime_1_num_steps_1000_towardsNull_0.1_gate_proj_fc1_[1, 3]_[7, 8, 17, 13]_0.0
...
for epsilon in allEpsilons:
    ...
    for attck_type in all_attck_types:
        ...
        for attackSample in range(1, numSamplesConsidered):
            ...
            cleanOutputPath = (
                f"llava_attack/outputsStorage/advOutputs/"
...
save_dir = "llava_attack/AllPlots/comparisionFinTestEpsilonSeries"
