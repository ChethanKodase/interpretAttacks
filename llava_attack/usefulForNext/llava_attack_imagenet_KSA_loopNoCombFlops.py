...
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llava_attack_imagenet_KSA_loopNoCombFlops.py --attck_type saa_loopNC_flops --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --BalAlpha 0 --whichMLP gate_proj --whichMLPVis fc1 --chosenLanLayers 1 3 --chosenVisLayers 7 8 17 13
done
