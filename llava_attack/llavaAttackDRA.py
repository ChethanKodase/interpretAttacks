...
python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.2 --learningRate 1e-3 --num_steps 1000 --attackSample 1
...
for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.0025 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.0035 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.0045 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done
...
for LayerDRA in $(seq 0 23); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample 1 --WhichLayerDRA $LayerDRA
done
...
conda activate llava15
for LayerDRA in $(seq 0 23); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample 2 --WhichLayerDRA $LayerDRA
done
...
conda activate llava15
for LayerDRA in $(seq 0 23); do
    python llava_attack/llavaAttackDRA.py --attck_type dra --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample 3 --WhichLayerDRA $LayerDRA
done
'''
