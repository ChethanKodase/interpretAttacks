...
python llava_attack/llavaConditioningPlots.py
...
def main():
    ...
    fig.tight_layout()
    fig.savefig("llava_attack/conditionAnalysis/llava_min_sing_valsCC.png", dpi=300)
    plt.show()
    plt.close()
    ...
    fig.tight_layout()
    fig.savefig("llava_attack/conditionAnalysis/llava_max_sing_valsCC.png", dpi=300)
    plt.show()
    ...
    fig.tight_layout()
    fig.savefig("llava_attack/conditionAnalysis/CondNumCC.png", dpi=300)
    plt.show()
    ...
    # ----- save report -----
    report_path = "llava_attack/conditionAnalysis/spectral_stats_report.txt"
