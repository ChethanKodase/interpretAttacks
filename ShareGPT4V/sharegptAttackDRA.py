...
python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.2 --learningRate 1e-3 --num_steps 1000 --attackSample 1
...
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.0025 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.0035 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.0045 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.001 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --WhichLayerDRA 16
done
...
for LayerDRA in $(seq 0 23); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample 1 --WhichLayerDRA $LayerDRA
done
...
conda activate share4v
for LayerDRA in $(seq 0 23); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample 2 --WhichLayerDRA $LayerDRA
done
...
conda activate share4v
for LayerDRA in $(seq 0 23); do
    python ShareGPT4V/sharegptAttackDRA.py --attck_type dra --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample 3 --WhichLayerDRA $LayerDRA
done
'''
...
def get_dra_vision_loss_from_acts(acts, WhichLayerDRA):
    ...
    Uses a single ShareGPT4V CLIP vision encoder layer's activations (no
    clean-image baseline needed). Minimizing this collapses token
    dispersion at that layer -- i.e. pushes every patch token toward the
    same mean vector, destroying the token-level information the language
    model relies on.
    """
    #h = acts[-1]
...
def adam_attack_original_space(
    ...
    for step in range(num_steps):
        ...
        if attck_type == "dra":
            ...
            raise ValueError(f"Unknown attck_type={attck_type}. Use dra")
...
def main():
    parser = argparse.ArgumentParser(
        description="ShareGPT4V-7B original-image-space DRA attack"
    )

    parser.add_argument("--attck_type", type=str, default="dra", help="dra")
    parser.add_argument(
        "--desired_norm_l_inf",
        type=float,
        default=0.01,
    ...
    parser.add_argument("--WhichLayerDRA", type=int, default=12)
