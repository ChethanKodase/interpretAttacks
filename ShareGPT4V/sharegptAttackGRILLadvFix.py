...
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.001 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.0015 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.0025 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.0035 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackGRILLadvFix.py --attck_type grillAdvFix --desired_norm_l_inf 0.0045 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
