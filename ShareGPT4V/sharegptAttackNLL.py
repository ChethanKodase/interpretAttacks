...
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.0025 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.0035 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python ShareGPT4V/sharegptAttackNLL.py --attck_type nllm --desired_norm_l_inf 0.0045 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
...
def build_attack_teacher_forced_inputs(
    ...
    so only the (teacher-forced) answer tokens contribute to
    Share4VLlamaForCausalLM's internally-computed outputs.loss.
    """
...
# ----------------------------
# ORIGINAL-image-space NLLm attack
# ----------------------------
...
def main():
    parser = argparse.ArgumentParser(
        description="ShareGPT4V-7B original-image-space NLLm attack"
    )
