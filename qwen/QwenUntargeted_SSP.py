...
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_SSP.py --attck_type ssp --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_SSP.py --attck_type ssp --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
