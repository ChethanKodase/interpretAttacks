...
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_EGA_flops.py --attck_type ega --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --ega_ratio 0.2 --mask_refresh_every 50 --attackSample $ATTACK_SAMPLE
done
