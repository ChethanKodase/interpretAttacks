...
python qwen/QwenUntargetedAttacks.py --attck_type grill_cos --desired_norm_l_inf 0.03 --learningRate 0.001 --sampleName astronauts --numSteps 10000
python qwen/QwenUntargetedAttacks.py --attck_type OA_cos --desired_norm_l_inf 0.03 --learningRate 0.001 --sampleName astronauts --numSteps 10000
python qwen/QwenUntargetedAttacks.py --attck_type grill_l2 --desired_norm_l_inf 0.03 --learningRate 0.001 --sampleName astronauts --numSteps 10000
python qwen/QwenUntargetedAttacks.py --attck_type OA_l2 --desired_norm_l_inf 0.03 --learningRate 0.001 --sampleName astronauts --numSteps 10000
python qwen/QwenUntargetedAttacks.py --attck_type grill_wass --desired_norm_l_inf 0.03 --learningRate 0.001 --sampleName astronauts --numSteps 10000
python qwen/QwenUntargetedAttacks.py --attck_type OA_wass --desired_norm_l_inf 0.03 --learningRate 0.001 --sampleName astronauts --numSteps 10000

blackHole, boat, cheetah, light, walker, nature, 
 


 --attck_type grill_wass --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample 550 --AttackStartLayer 2 --numLayerstAtAtime 1
...
rm -r /mdadm0/chethan_krishnamurth/interpretAttacks/qwen/outputsStorage/convergence/astronauts/*
rm -r /mdadm0/chethan_krishnamurth/interpretAttacks/qwen/outputsStorage/convergence/blackHole/*
rm -r /mdadm0/chethan_krishnamurth/interpretAttacks/qwen/outputsStorage/convergence/boat/*
rm -r /mdadm0/chethan_krishnamurth/interpretAttacks/qwen/outputsStorage/convergence/cheetah/*
rm -r /mdadm0/chethan_krishnamurth/interpretAttacks/qwen/outputsStorage/convergence/dogs/*
rm -r /mdadm0/chethan_krishnamurth/interpretAttacks/qwen/outputsStorage/convergence/light/*
rm -r /mdadm0/chethan_krishnamurth/interpretAttacks/qwen/outputsStorage/convergence/nature/*
rm -r /mdadm0/chethan_krishnamurth/interpretAttacks/qwen/outputsStorage/convergence/walker/*
...
IMAGE_PATH = f"qwen/dataSamples/{sampleName}68.jpg"
...
def adam_attack_on_patches(
    ...
    for step in range(num_steps):
        ...
        if max(lossesList) < loss.item():
            ...
            np.save(f"qwen/outputsStorage/convergence/{sampleName}/vlm_attack_type__given_attackType_{attck_type}_lr_{learningRate}_epsilon_{desired_norm_l_inf}_.npy", lossesList)
...
def main():
    ...
    save_adv_image_from_pixel_values(
        ...
        inputs,
        processor,
        save_path=f"qwen/outputsStorage/{sampleName}/adv_imagegiven_attackType_{attck_type}_lr_{learningRate}_epsilon_{desired_norm_l_inf}_.png",
    )
    ...
    # SAVE TO TEXT FILE
    # --------------------------------------------------------
    filename = f"qwen/outputsStorage/{sampleName}/output_given_attackType_{attck_type}_lr_{learningRate}_epsilon_{desired_norm_l_inf}_.txt"
