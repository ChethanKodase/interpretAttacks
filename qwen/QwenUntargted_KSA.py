...
for ATTACK_SAMPLE in $(seq 1 500); do
    python qwen/QwenUntargted_KSA.py --attck_type saa --desired_norm_l_inf 0.04 --learningRate 0.001 --numSteps 1000 --attackSample $ATTACK_SAMPLE --towardsNull 0 --AlignLayer 1
done
...
export PYTHONNOUSERSITE=1
for ATTACK_SAMPLE in $(seq 1 500); do
    python qwen/QwenUntargted_KSA.py --attck_type saa --desired_norm_l_inf 0.04 --learningRate 0.001 --numSteps 1000 --attackSample $ATTACK_SAMPLE --towardsNull 0.5 --AlignLayer 1
done
