...
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loopTop.py --attck_type saa_loopTop --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loopTop.py --attck_type saa_loopTop --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loopTop.py --attck_type saa_loopTop --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loopTop.py --attck_type saa_loopTop --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24
done
for ATTACK_SAMPLE in $(seq 1 50); do
