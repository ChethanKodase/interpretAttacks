...
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_cost.py --attck_type grill_cost --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
...
export PYTHONNOUSERSITE=1
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_cost.py --attck_type grill_cost --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
...
for ATTACK_SAMPLE in $(seq 14 50); do
    python qwen/QwenUntargeted_cost.py --attck_type grill_cost --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 100 --attackSample $ATTACK_SAMPLE
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_cost.py --attck_type grill_cost --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 100 --attackSample $ATTACK_SAMPLE
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_cost.py --attck_type grill_cost --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 100 --attackSample $ATTACK_SAMPLE
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_cost.py --attck_type grill_cost --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 100 --attackSample $ATTACK_SAMPLE
done
...
export PYTHONNOUSERSITE=1
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargeted_cost.py --attck_type grill_cost --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 5000 --attackSample $ATTACK_SAMPLE
done
...
def get_grill_lan_vis_loss(acts, actsN, outputs, outputsN):
    loss = 0.0
    ...
    lastCosMean = cos_per_token.mean()

    # (1 - loss)**2 * (1-lastCosMean)**2

    return loss * lastCosMean
...
def adam_attack_original_space(
    ...
    for step in range(num_steps):
        ...
        loss = 1 * get_grill_lan_vis_loss(acts, actsN, outputs, outputsN)
