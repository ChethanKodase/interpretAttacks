...
export PYTHONNOUSERSITE=1
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.001 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.01
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.01
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.01
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.01
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.01
done
...
export PYTHONNOUSERSITE=1
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.001 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.05
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.05
done
...
conda activate vlmAttack
export PYTHONNOUSERSITE=1
python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample 1 --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.05
...
export PYTHONNOUSERSITE=1
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.0025 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.05
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.0035 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.05
done
for ATTACK_SAMPLE in $(seq 1 50); do
    python qwen/QwenUntargted_KSA_loop_comb.py --attck_type saa_loopC --desired_norm_l_inf 0.0045 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5 --whichMLP gate_proj --whichMLPVis gate_proj --chosenLanLayers 2 --chosenVisLayers 0 1 2 4 5 6 7 8 9 14 24 --BalAlpha 0.05
done
...
def adam_attack_original_space(
    ...
    for step in range(num_steps):
        ...
        spectralLoss = language_loss + vision_loss

        loss = spectralLoss * (1-BalAlpha) + Bsaloss * BalAlpha
        attack_loss = loss
...
def main():
    ...
    parser.add_argument("--BalAlpha", type=float, default=0.1, help="BalAlpha")
