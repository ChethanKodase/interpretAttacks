...
for ATTACK_SAMPLE in $(seq 1 500); do
    for LAYER in $(seq 0 27); do
        python qwen/QwenAlignmentCheckLanUntargetedAttacks.py --attck_type grill_wass --desired_norm_l_inf 0.04 --learningRate 0.001 --numSteps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $LAYER --numLayerstAtAtime 1
    done
done
