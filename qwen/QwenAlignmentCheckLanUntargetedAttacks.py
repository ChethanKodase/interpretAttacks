...
python qwen/QwenAlignmentCheckLanUntargetedAttacks.py --attck_type grill_wass --desired_norm_l_inf 0.02 --learningRate 0.001 --numSteps 1000 --attackSample 550 --AttackStartLayer 2 --numLayerstAtAtime 1
...
for ATTACK_SAMPLE in $(seq 1 500); do
    for LAYER in $(seq 0 27); do
        python qwen/QwenAlignmentCheckLanUntargetedAttacks.py --attck_type grill_wass --desired_norm_l_inf 0.03 --learningRate 0.001 --numSteps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $LAYER --numLayerstAtAtime 1
    done
done
...
def main():
    ...
    advOutTxt = f"qwen/outputsStorageImagenet/advOutputs/{attackSample}/advOutput_attackType_{attck_type}_lr_{learningRate}_eps_{desired_norm_l_inf}_AttackStartLayer_{AttackStartLayer}_numLayerstAtAtime_{numLayerstAtAtime}_num_steps_{numSteps}_.txt"
