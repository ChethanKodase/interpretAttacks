...
for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/FLOPSestimation/gemma3AttackImgenet_SSGRA_flops.py --attck_type saa_BSAexp_flops --desired_norm_l_inf 0.0045 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --towardsNull 0.15 --whichMLP up_proj --whichMLPvis fc2 \
    --balancingAlpha 0.5\
