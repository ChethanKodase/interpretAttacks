...
for ATTACK_SAMPLE in $(seq 1 250); do
    python gemma_attack/gemma3AttackImgenet_DRA_flops.py --attck_type dra_flops --desired_norm_l_inf 0.01 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
