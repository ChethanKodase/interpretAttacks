...
cd interpretAttacks
python gemma_attack/gemma3BaselinesAndOursComparisionAllEpsilonSubReady.py --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --AttackStartLayer_vis 11 --whichMLP gate_proj --whichMLP_vis fc2 --numSamplesConsidered 50 --perturbationScale tinyTiny

export CUDA_VISIBLE_DEVICES=2
conda activate gemma3
cd interpretAttacks
python gemma_attack/gemma3BaselinesAndOursComparisionAllEpsilonSubReady.py --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --AttackStartLayer_vis 11 --whichMLP gate_proj --whichMLP_vis fc2 --numSamplesConsidered 50 --perturbationScale tiny
...
for epsilon in allEpsilons:
    ...
    precisionMeanForAttacksSeries.append(np.array(precisionMeanForAttacks))
    precisionStdForAttacksSeries.append(np.array(precisionStdForAttacks))

    recallMeanForAttacksSeries.append(np.array(recallMeanForAttacks))
    recallStdForAttacksSeries.append(np.array(recallStdForAttacks))

    f1MeanForAttacksSeries.append(np.array(f1MeanForAttacks))
    f1StdForAttacksSeries.append(np.array(f1StdForAttacks))
