...
for ATTACK_START_LAYER in $(seq 0 27); do
    for ATTACK_SAMPLE in $(seq 1 10); do
        python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP out_proj
    done
done
...
for ATTACK_START_LAYER in $(seq 0 27); do
    for ATTACK_SAMPLE in $(seq 1 10); do
        python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
    done
done
...
for ATTACK_START_LAYER in $(seq 0 27); do
    for ATTACK_SAMPLE in $(seq 1 10); do
        python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
    done
done
...
for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.05 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.04 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.03 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.01 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done
...
cd interpretAttacks
for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.04 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.03 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv_flops.py --attck_type saav_flops --desired_norm_l_inf 0.01 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done
