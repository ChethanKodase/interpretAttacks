...
for LAYER in $(seq 30 34); do
    python gemma_attack/gemma3AttackImgenet.py --attck_type grill_wass --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample 336 --AttackStartLayer $LAYER --numLayerstAtAtime 1
done

for ATTACK_SAMPLE in $(seq 337 500); do
