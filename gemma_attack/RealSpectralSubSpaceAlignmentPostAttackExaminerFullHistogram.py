...
##########################################################################################################################################################################################################################################################################################
RealSpectralSubSpaceAlignmentPostAttackExaminer

# 2, 5, 10


interpretAttacks/gemma_attack/outputsStorageImagenet/advOutputs/2/advOutput_attackType_saa_BSAexp_lr_0.001_eps_0.005_AttackStartLayer_0_numLayerstAtAtime_2_num_steps_1000_towardsNull_0.15_lanMLP_up_proj_visMLP_fc2_lanLayers_upto4_visLayers_all_balancingAlpha_0.5.txt
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
for StudyLayer in $(seq 0 33); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec 10 --attackMode lan
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan
done

for StudyLayer in $(seq 0 26); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec -10 --attackMode vis
done

for StudyLayer in $(seq 0 26); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 5 --attackMode vis
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec -5 --attackMode vis
done

for StudyLayer in $(seq 0 33); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec 5 --attackMode lan
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -5 --attackMode lan
done

for StudyLayer in $(seq 0 33); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec 20 --attackMode lan
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -20 --attackMode lan
done

for StudyLayer in $(seq 0 26); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 20 --attackMode vis
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec -20 --attackMode vis
done
...
python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 1 --kthSingVec -10 --attackMode lan





python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogram.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 0 --kthSingVec -10 --attackMode vis
...
def main():
    ...
    for i in range(len(FlattenedAlignmentDistributionsAdversary)):
        ...
        orig = FlattenedAlignmentDistributionsOriginal[i].detach().to(torch.float32).cpu().numpy()
        adv = FlattenedAlignmentDistributionsAdversary[i].detach().to(torch.float32).cpu().numpy()
        ...
        bins = np.linspace(lo, hi, 30 + 1)

        plt.figure(figsize=(5, 3.5))
        plt.hist(orig, bins=bins, alpha=0.5, density=True, label="Original", color="green", edgecolor="black")
        plt.hist(adv, bins=bins, alpha=0.5, density=True, label="Attacked", color="red", edgecolor="black")
        plt.axvline(orig.mean(), color="green", linestyle="--", linewidth=1.5)
        plt.axvline(adv.mean(), color="red", linestyle="--", linewidth=1.5)
        plt.xlabel("Projection coefficient (mean over tokens)")
        plt.ylabel("Density")
        plt.title(f"{label} — Original vs Attacked")
        plt.legend()
        plt.tight_layout()

        save_dir = f"/data1/chethan/interpretAttacks/gemma_attack/HistoGrams/sampleNum{attackSample}"
        os.makedirs(save_dir, exist_ok=True)
        save_path = os.path.join(
            save_dir,
            f"Hist_{label.replace(' ', '_')}_attackSample_{attackSample}_attackMode_{attackMode}_LanLayerTrack_{LanLayerTrack})_VisionLayerTrack_{VisionLayerTrack}.png"
        )
    ...
    for i in range(len(FlattenedAlignmentDistributionsAdversary)):
            ...
            orig = abs(orig)
            adv = abs(adv)
            # orig/adv are ordered top-singular-vector -> bottom-singular-vector (index 0 = top).
            # Reverse so the RIGHTMOST bar = top singular vector, LEFTMOST bar = bottom singular vector.
            #orig_r = orig[::-1]
            #adv_r = adv[::-1]
            ...
            axes[0].bar(x, orig, width=1.0, color="green", edgecolor="none")
            axes[0].set_title(f"{label} — Original")
            axes[0].set_xlabel("<- top singular vector   |   bottom singular vector ->")
            axes[0].set_ylabel("Alignment")

            axes[1].bar(x, adv, width=1.0, color="red", edgecolor="none")
            axes[1].set_title(f"{label} — Attacked")
            axes[1].set_xlabel("<- top singular vector   |   bottom singular vector ->")

            plt.tight_layout()

            save_dir = f"/data1/chethan/interpretAttacks/gemma_attack/HistoGrams2/sampleNum{attackSample}"
            os.makedirs(save_dir, exist_ok=True)
            save_path = os.path.join(
                save_dir,
