...
cd interpretAttacks
for ATTACK_START_LAYER in $(seq 0 27); do
    for ATTACK_SAMPLE in $(seq 1 10); do
        python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP out_proj
    done
done
...
for ATTACK_START_LAYER in $(seq 0 27); do
    for ATTACK_SAMPLE in $(seq 1 10); do
        python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
    done
done
...
for ATTACK_START_LAYER in $(seq 0 27); do
    for ATTACK_SAMPLE in $(seq 1 10); do
        python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
    done
done
...
for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.05 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.04 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.03 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.01 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc1
done
...
cd interpretAttacks
for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_KSAmv.py --attck_type saav --desired_norm_l_inf 0.001 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 11 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP fc2
done



for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_SSP.py --attck_type ssp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_SSP.py --attck_type ssp --desired_norm_l_inf 0.004 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_SSP.py --attck_type ssp --desired_norm_l_inf 0.003 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_SSP.py --attck_type ssp --desired_norm_l_inf 0.002 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done

for ATTACK_SAMPLE in $(seq 1 50); do
    python gemma_attack/gemma3AttackImgenet_SSP.py --attck_type ssp --desired_norm_l_inf 0.001 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE
done
...
def adam_attack_original_space(
    ...
    if whichMLP == "out_proj":
        #paramWt = model.language_model.model.layers[AttackStartLayer].mlp.gate_proj.weight
        paramWt = model.vision_tower.vision_model.encoder.layers[AttackStartLayer].self_attn.out_proj.weight
    if whichMLP == "fc1":
        #paramWt = model.language_model.model.layers[AttackStartLayer].mlp.up_proj.weight
        paramWt = model.vision_tower.vision_model.encoder.layers[AttackStartLayer].mlp.fc1.weight
    if whichMLP == "fc2":
        #paramWt = model.language_model.model.layers[AttackStartLayer].mlp.down_proj.weight
        paramWt = model.vision_tower.vision_model.encoder.layers[AttackStartLayer].mlp.fc2.weight
...
def main():
    ...
    parser.add_argument("--towardsNull", type=float, default=2,
                        help="What percentage of absorbing singular vector directions we consider")
    ...
    if whichMLP == "out_proj":
        #gate_proj = model.language_model.model.layers[AttackStartLayer].mlp.gate_proj
        out_proj = model.vision_tower.vision_model.encoder.layers[AttackStartLayer].self_attn.out_proj
        hook_handle = out_proj.register_forward_pre_hook(down_proj_pre_hook)

    if whichMLP == "fc1":
        #up_proj = model.language_model.model.layers[AttackStartLayer].mlp.up_proj
        fc1 = model.vision_tower.vision_model.encoder.layers[AttackStartLayer].mlp.fc1
        hook_handle = fc1.register_forward_pre_hook(down_proj_pre_hook)

    if whichMLP == "fc2":
        #down_proj = model.language_model.model.layers[AttackStartLayer].mlp.down_proj
        paramWt = model.vision_tower.vision_model.encoder.layers[AttackStartLayer].mlp.fc2
        hook_handle = paramWt.register_forward_pre_hook(down_proj_pre_hook)
    ...
    # Attack
    conv_path = f"gemma_attack/outputsStorageImagenet/convergence/{attackSample}/gemma_ORIG_attack_{attck_type}_lr_{lr}_eps_{epsilon}_AttackStartLayer_{AttackStartLayer}_numLayerstAtAtime_{numLayerstAtAtime}_num_steps_{num_steps}_towardsNull_{towardsNull}.npy"
    ...
    adv_img_path = f"gemma_attack/outputsStorageImagenet/advOutputs/{attackSample}/adv_ORIG_attackType_{attck_type}_lr_{lr}_eps_{epsilon}_AttackStartLayer_{AttackStartLayer}_numLayerstAtAtime_{numLayerstAtAtime}_num_steps_{num_steps}_towardsNull_{towardsNull}_{whichMLP}.png"

    adv_noise_path = f"gemma_attack/outputsStorageImagenet/advOutputs/{attackSample}/adv_ORIG_attackType_{attck_type}_lr_{lr}_eps_{epsilon}_AttackStartLayer_{AttackStartLayer}_numLayerstAtAtime_{numLayerstAtAtime}_num_steps_{num_steps}_towardsNull_{towardsNull}_{whichMLP}.pt"
    ...
    advOutTxt = f"gemma_attack/outputsStorageImagenet/advOutputs/{attackSample}/advOutput_attackType_{attck_type}_lr_{lr}_eps_{epsilon}_AttackStartLayer_{AttackStartLayer}_numLayerstAtAtime_{numLayerstAtAtime}_num_steps_{num_steps}_towardsNull_{towardsNull}_{whichMLP}.txt"
