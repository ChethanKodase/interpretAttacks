...
cd interpretAttacks
python gemma_attack/gemma3QuantitativeEvalTextLayers.py  --attck_type grill_wass --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1
...
plt.savefig(
    "gemma_attack/AllPlots/bertScores/sampleSpecific/Text_Precision_vs_hiddenstate.png",
    dpi=300,
    bbox_inches="tight"
)
plt.close()
...
plt.savefig(
    "gemma_attack/AllPlots/bertScores/sampleSpecific/Text_recall_vs_hiddenstate.png",
    dpi=300,
    bbox_inches="tight"
)
plt.close()
...
plt.savefig(
    "gemma_attack/AllPlots/bertScores/sampleSpecific/Text_f1score_vs_hiddenstate.png",
    dpi=300,
    bbox_inches="tight"
)
plt.close()
