...
for ATTACK_SAMPLE in $(seq 1 10); do
    python gemma_attack/gemma3AttackImgenet_KSAm_loop1Top.py --attck_type saa_loopRtop --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --towardsNull 0.1 --whichMLP down_proj --whichMLPvis out_proj \
...
for ATTACK_SAMPLE in $(seq 41 50); do
    python gemma_attack/gemma3AttackImgenet_KSAm_loop1Top.py --attck_type saa_loopRtoptop --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --towardsNull 0.1 --whichMLP down_proj --whichMLPvis out_proj \
    --chosenLanLayers 3 4 5 \
    --chosenVisLayers 1 3 5 10 11 12 15 17 21 23
done
...
####################
advOutput_attackType_saa_loopRtop_lr_0.001_eps_0.002_AttackStartLayer_0_numLayerstAtAtime_2_num_steps_1000_towardsNull_0.1_lanMLP_down_proj_visMLP_out_proj_lanLayers_[3, 4, 5]_visLayers_[1, 3, 5, 10, 11, 12, 15, 17, 21, 23]
