...
for StudyLayer in $(seq 0 33); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec 10 --attackMode lan
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -10 --attackMode lan
done

for StudyLayer in $(seq 0 26); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec -10 --attackMode vis
done

for StudyLayer in $(seq 0 26); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 5 --attackMode vis
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec -5 --attackMode vis
done

for StudyLayer in $(seq 0 33); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec 5 --attackMode lan
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -5 --attackMode lan
done

for StudyLayer in $(seq 0 33); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec 20 --attackMode lan
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack $StudyLayer --kthSingVec -20 --attackMode lan
done

for StudyLayer in $(seq 0 26); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 20 --attackMode vis
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec -20 --attackMode vis
done
...
cd interpretAttacks
for StudyLayer in $(seq 0 26); do
    python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitativeVis.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack $StudyLayer --LanLayerTrack 0 --kthSingVec 10 --attackMode vis
done


python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 1 --kthSingVec -10 --attackMode lan





python gemma_attack/RealSpectralSubSpaceAlignmentPostAttackExaminerFullHistogramQuantitative.py --attck_type saa_BSAexp --desired_norm_l_inf 0.005 --learningRate 0.001 --num_steps 1000 --AttackStartLayer 0 --numLayerstAtAtime 1 --VisionLayerTrack 0 --LanLayerTrack 0 --kthSingVec -10 --attackMode vis
