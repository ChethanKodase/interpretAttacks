...
for ATTACK_SAMPLE in $(seq 1 250); do
    python gemma_attack/gemma3AttackImgenet_BSA.py --attck_type bsa --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 10000 --attackSample $ATTACK_SAMPLE
done
...
cd interpretAttacks
for ATTACK_SAMPLE in $(seq 1 250); do
    python gemma_attack/gemma3VisionAttackImgenet.py --attck_type bsa --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 27
done
