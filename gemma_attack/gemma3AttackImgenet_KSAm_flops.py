...
cd interpretAttacks
python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample 550 --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1
python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample 550 --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.5
python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample 550 --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 1.0
python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample 550 --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0
...
for ATTACK_SAMPLE in $(seq 1 10); do
    python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.05 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP down_proj
done
...
for ATTACK_START_LAYER in $(seq 0 34); do
    for ATTACK_SAMPLE in $(seq 1 20); do
        python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.05 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP down_proj
    done
done
...
for ATTACK_START_LAYER in $(seq 0 34); do
    for ATTACK_SAMPLE in $(seq 1 20); do
        python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.05 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP up_proj
    done
done
...
for ATTACK_START_LAYER in $(seq 0 34); do
    for ATTACK_SAMPLE in $(seq 1 20); do
        python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.05 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer $ATTACK_START_LAYER --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP gate_proj
    done
done
...
for ATTACK_SAMPLE in $(seq 50 250); do
    python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.05 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP gate_proj
done

for ATTACK_SAMPLE in $(seq 50 250); do
    python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.04 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP gate_proj
done

for ATTACK_SAMPLE in $(seq 50 250); do
    python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.03 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP gate_proj
done

for ATTACK_SAMPLE in $(seq 50 250); do
    python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.02 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP gate_proj
done

for ATTACK_SAMPLE in $(seq 50 250); do
    python gemma_attack/gemma3AttackImgenet_KSAm_flops.py --attck_type saa_flops --desired_norm_l_inf 0.01 --learningRate 0.001 --num_steps 1000 --attackSample $ATTACK_SAMPLE --AttackStartLayer 0 --numLayerstAtAtime 1 --towardsNull 0.1 --whichMLP gate_proj
done
...
def main():
    ...
    if whichMLP == "gate_proj":
        ...
        hook_handle = gate_proj.register_forward_pre_hook(down_proj_pre_hook)
