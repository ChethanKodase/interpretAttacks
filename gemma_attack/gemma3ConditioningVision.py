...
cd interpretAttacks
python gemma_attack/gemma3ConditioningVision.py 
...
def main():
    ...
    if plotFinishedThings:
        ...
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/queryMaxSingularPlot.png", dpi=300)
        plt.show()
        plt.close()
        ...
        ax.view_init(elev=30, azim=-60)
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/queryMinSingularPlot_log.png", dpi=300)
        plt.show()
        plt.close()
        ...
        ax.view_init(elev=30, azim=60)
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/queryConditionNumber.png", dpi=300)
        plt.show()
        plt.close()
        #-------------------------------------------------QuerySingularValuesPlots--------------------------------------------------
        ...
        ax.view_init(elev=30, azim=60)
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/keyMaxSingularPlot.png", dpi=300)
        plt.show()
        plt.close()
        ...
        ax.view_init(elev=30, azim=-60)
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/keyMinSingularPlot_log.png", dpi=300)
        plt.show()
        plt.close()
        ...
        ax.view_init(elev=30, azim=60)
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/keyConditionNumber.png", dpi=300)
        plt.show()
        plt.close()
        #-------------------------------------------------KeySingularValuesPlots--------------------------------------------------
        ...
        ax.view_init(elev=30, azim=60)
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/ValueMaxSingularPlot.png", dpi=300)
        plt.show()
        plt.close()
        ...
        ax.view_init(elev=30, azim=-60)
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/ValueMinSingularPlot_log.png", dpi=300)
        plt.show()
        plt.close()
        ...
        ax.view_init(elev=30, azim=60)
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/ValueConditionNumber.png", dpi=300)
        plt.show()
        plt.close()
        #-------------------------------------------------ValueSingularValuesPlots--------------------------------------------------
        ...
        plt.barh(y - height, valuesOutProj, height, label='AOP', color='tab:blue')
        plt.barh(y, valuesFc1, height, label='FC1', color='tab:orange')
        plt.barh(y + height, valuesFc2, height, label='FC2', color='tab:green')
        ...
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/outProjFc1Fc2MinSingularPlot_horizontal.png", dpi=300)
        ...
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/outProjFc1Fc2MaxSingularPlot_horizontal.png", dpi=300)
        ...
        plt.legend(loc='center left', bbox_to_anchor=(1, 0.5))
        plt.tight_layout()
        plt.savefig("/data1/chethan/interpretAttacks/gemma_attack/AllPlots/singularValuesPlot/outProjFc1Fc2ConditionNumberPlot_horizontal.png", dpi=300)
